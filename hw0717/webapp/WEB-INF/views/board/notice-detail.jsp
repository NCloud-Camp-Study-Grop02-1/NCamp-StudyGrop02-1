            ...
            <div class="container mt-3 w-50">
                <form id="modify-form" action="/board/modify.do" method="post">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="regdate" name="regdate" value="<javatime:format value="${notice.regdate}" pattern="yyyy-MM-dd"/>" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="moddate">수정일</label>
                        <input type="text" class="form-control" id="moddate" name="moddate" value="<javatime:format value="${notice.moddate}" pattern="yyyy-MM-dd"/>" required>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <c:if test="${loginMember.role eq 'ADMIN'}">
                        <div class="container mt-3 mb-5 w-50 text-center">
                            ...
                            <button type="button" id="btn-delete" class="btn btn-outline-secondary ml-2"
                                    onclick="location.href='/board/delete.do?id=${notice.id}&type=notice'">삭제</button>
                        </div>
                    </c:if>
                </form>
            </div>
